 ...
 class dqueue
    {
       ...
       public:
         ...
         int top1, top2;		// Class declaration
         void insert();
	 void del();
         void display();
    ...
    void dqueue::insert()			//	 * Insert  an Element in Doubly Ended Queue
    ...
    void dqueue::del()				//	 * Delete Element in Doubly Ended Queue
    ...
    void dqueue::display()				//	 * Display Doubly Ended Queue
